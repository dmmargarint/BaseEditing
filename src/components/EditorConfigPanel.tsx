  ...
  return (
    <>
      <div className="w-full justify-center">
        ...
        <legend className="fieldset-legend text-xs">Base Editor Type</legend>
        <select
        ...
        <legend className="fieldset-legend text-xs">Mutation Position (or highlight the mutation in the visualiser)</legend>
        <input type="text"
