    ...
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body">
        ...
        <div className="space-y-2">
          ...
          <div><b>Original Sequence:</b> <span>{guide.seq}</span></div>
          <div><b>Edited Sequence:</b> <span>{guide.editsSimulation.finalSeqOverGuideLength}</span></div>
        ...
        <div className="space-y-2">
          ...
          <div><b>Editing Window:</b> {guide.protospacer.editWindowStart}–{guide.protospacer.editWindowEnd}</div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div><b>Bystanders:</b> {guide.summary?.numBystanders ?? 0}</div>
          <div><b>Hits Target:</b> {guide.summary?.hitsDesiredSite ? "Yes" : "No"}</div>
        </div>
