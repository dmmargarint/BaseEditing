...
const navigation = [
  { name: 'Base Editing Dashboard', href: '#', current: true },
    ...
    <Disclosure as="nav" className="relative bg-white border-2 border-gray-200 border-solid border-t-0">
      <div className="mx-0 max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-12 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">s
            {/* Mobile menu button*/}
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-blue/5 hover:text-blue-950',
